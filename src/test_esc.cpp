...
static const iit::ecat::objd_t source_SDOs[] = {
    ...
    // SD0 0x8002
    { 0x8002, 1, DTYPE_REAL32,      32, ATYPE_RW, "volt_ref",       0},
    { 0x8002, 2, DTYPE_REAL32,      32, ATYPE_RO, "current",        0},
    { 0x8002, 3, DTYPE_REAL32,      32, ATYPE_RO, "vout",           0},
    { 0x8002, 4, DTYPE_REAL32,      32, ATYPE_RO, "pos_ref_fb",     0},
