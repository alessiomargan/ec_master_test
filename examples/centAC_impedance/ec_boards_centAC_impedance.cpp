...
EC_boards_centAC_impedance::EC_boards_centAC_impedance ( const char* config_yaml ) :
...
EC_boards_centAC_impedance::~EC_boards_centAC_impedance() {
 ...
 *
 */
void EC_boards_centAC_impedance::init_preOP ( void ) {
...
int EC_boards_centAC_impedance::user_loop ( void ) {
...
void EC_boards_centAC_impedance::tune_gains( std::vector<float> gains_incr ) {
...
int EC_boards_centAC_impedance::xddp_input ( iit::advr::Ec_board_base_input &pbEcInput ) {
