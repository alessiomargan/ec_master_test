/*
   Copyright (C) 2017 Italian Institute of Technology
...
/**
 *
 * @author Alessio Margan (2017-, alessio.margan@iit.it)
*/

#ifndef __EC_BOARDS_URDF_H__
#define __EC_BOARDS_URDF_H__
...
class EC_boards_urdf : public Ec_Thread_Boards_base, URDF_adapter {
public:


    EC_boards_urdf ( const char * config_yaml );
    virtual ~EC_boards_urdf();
