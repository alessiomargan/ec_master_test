...
#ifndef __IIT_ECAT_ADVR_MC_LOWPWR_SPH_ESC_H__
#define __IIT_ECAT_ADVR_MC_LOWPWR_SPH_ESC_H__
...
class LpSphESC :
    ...
    public PDO_log<LoPwrSphLogTypes>
    //public MotorSph
{
public:
    ...
    LpSphESC(const ec_slavet& slave_descriptor) :
        ...
        Log(std::string("/home/embedded/PDO_log/LpSphESC_pos"+std::to_string(position)+"_log.txt"),DEFAULT_LOG_SIZE)
    {
	...
	readSDO_byname("link_pos");
        ...
        log_filename = std::string("/home/embedded/PDO_log/LpSphESC_"+std::to_string(sdo.Joint_robot_id)+"_log.txt");
