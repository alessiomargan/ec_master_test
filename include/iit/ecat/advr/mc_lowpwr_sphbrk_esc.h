...
public:
    ...
    LpSphBrkESC(const ec_slavet& slave_descriptor) :
        ...
        Log(std::string("/home/PDO_log/embedded/LpSphBrkESC_pos"+std::to_string(position)+"_log.txt"),DEFAULT_LOG_SIZE)
    {
	...
	readSDO_byname("link_pos");
        ...
        log_filename = std::string("/home/PDO_log/embedded/LpSphBrkESC_"+std::to_string(sdo.Joint_robot_id)+"_log.txt");
